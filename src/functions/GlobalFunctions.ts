                ...
                chunk.elements.forEach((productElement) => {
                    ...
                    if (productElement.symbol === countListElement.symbol) {
                        numOfElementPresentProducts +=
                            productElement.subscript.value * product.coefficient * parenSub
                    }
                })
            })
        })
